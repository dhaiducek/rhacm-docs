...
- You can now use the `fromYaml` and `toYaml` Go template functions in `ConfigurationPolicy` to parse YAML strings. More
Sprig functions are also added to the list of available functions.
